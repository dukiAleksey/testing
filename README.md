...
*d. Можно ли изменить адреса стандартных страниц, например checkout, cart, my­account и пр? Если да, то как?*
...
Судя из документации этот код создаст шорткод с двумя полями. Первое - текстовое, второе - выбор цвета. Цвет по умолчанию указан красный. 
